...
import (
	...
	v1 "cosmossdk.io/x/accounts/defaults/ethbase/v1"
	aa_interface_v1 "cosmossdk.io/x/accounts/interfaces/account_abstraction/v1"
	accountsv1 "cosmossdk.io/x/accounts/v1"
	"cosmossdk.io/x/tx/signing"

	ethsecp256k1 "cosmossdk.io/x/accounts/defaults/ethbase/ethstuff"
	...
	return func(deps accountstd.Dependencies) (string, accountstd.Interface, error) {
		return name, Account{
			PubKey: collections.NewItem(
				...
				PubKeyPrefix,
				"pub_key",
				codec.CollValue[ethsecp256k1.PubKey](deps.LegacyStateCodec),
			),
...
type Account struct {
	PubKey   collections.Item[ethsecp256k1.PubKey]
...
func (a Account) verifyAndSetPubKey(ctx context.Context, key []byte) error {
	...
	return a.PubKey.Set(ctx, ethsecp256k1.PubKey{Key: key})
}
...
func (a Account) computeSignerData(ctx context.Context) (ethsecp256k1.PubKey, signing.SignerData, error) {
	addrStr, err := a.addrCodec.BytesToString(accountstd.Whoami(ctx))
	if err != nil {
		return ethsecp256k1.PubKey{}, signing.SignerData{}, err
	}
